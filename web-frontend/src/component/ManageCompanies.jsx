...
export default function ManageCompanies() {
    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                ...
                // API Data Format check (Support for both .companies and .data)
    ...
    const filteredCompanies = companies.filter(company => 
        ...
        company.zoneIds?.some(z => (z.name || z.city || '').toLowerCase().includes(searchTerm))
    );
                ...
                <main className="flex-1 overflow-y-auto p-6 lg:p-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                            ...
                            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">{filteredCompanies.length} Companies</span>
                        </div>
